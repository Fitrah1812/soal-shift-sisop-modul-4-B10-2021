...
static const char *dirPath = "/home/lathifa/Downloads";

// gcc -Wall `pkg-config fuse --cflags` SinSeiFS_B10.c -o SinSeiFS_B10 `pkg-config fuse --libs`

// ./SinSeiFS_B10  cobadulu

// fusermount -u cobadulu
...
void tulisLog(char *nama, char *fpath)
{
	...
	file = fopen("/home/lathifa/SinSeiFS.log", "a");
